...
urlpatterns = [
    ...
    path('<int:user_id>/follower',views.follower_list_view,name='follower_list_view'),
    path('<int:user_id>/following',views.following_list_view,name='following_list_view'),
